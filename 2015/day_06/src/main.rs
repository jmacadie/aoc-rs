...
mod tests {
    ...
    fn test_right_mask() {
        ...
        assert_eq!(right_mask(10), 0b11111111111);
    }

    #[test]
    fn test_left_mask() {
        assert_eq!(left_mask(0), 0b1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111);
        assert_eq!(left_mask(1), 0b1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111110);
        assert_eq!(left_mask(10), 0b1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111110000000000);
    }

    #[test]
    fn test_part_mask() {
        assert_eq!(part_mask(0, 1), 0b11);
        assert_eq!(part_mask(1, 10), 0b11111111110);
        assert_eq!(part_mask(10, 20), 0b111111111110000000000);
    }
